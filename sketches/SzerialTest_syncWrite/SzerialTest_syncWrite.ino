...
/////////////////////////////////////////////////////////////////////////
const uint8_t numServos = 2; //This could be any type of actuator, to which you give a command, and read an output. 
...
Szerial szerial(&SerialUSB, 2*numServos, numInAnalog, numOutAnalog);
